...
namespace Apos.WintabDN {
    ...
    public struct WintabPacket {
        ...
        /// <summary>
        /// In absolute mode, is a uint containing the current button state.
        /// In relative mode, is a uint whose low word contains a button number,
        /// and whose high word contains one of the codes in EWintabPacketButtonCode.
        /// </summary>
        public uint pkButtons;                    // PK_BUTTONS

        /// <summary>
        /// In absolute mode, each is a uint containing the scaled cursor location
    ...
    public class CWintabData {
        ...
        private void Init(CWintabContext context_I) {
            try {
                m_context = context_I ?? throw new Exception("Trying to init CWintabData with null context.");
            }
            catch (Exception ex) {
                throw new Exception($"FAILED CWintabData.Init: {ex}");
            }
        }
        ...
        public bool SetPacketQueueSize(uint numPkts_I) {
            ...
            try {
                ...
                throw new Exception($"FAILED SetPacketQueueSize: {ex}");
            }
        ...
        public uint GetPacketQueueSize() {
            ...
            try {
                ...
                throw new Exception($"FAILED GetPacketQueueSize: {ex}");
            }
        ...
        public void BringToFront() {
            try {
                ...
                throw new Exception($"FAILED BringToFront: {ex}");
            }
        }
        ...
        public WintabPacketExt GetDataPacketExt(uint hCtx_I, uint pktID_I) {
            ...
            try {
                ...
                throw new Exception($"FAILED GetDataPacketExt: {ex}");
            }
        ...
        public void FlushDataPackets(uint numPacketsToFlush_I) {
            try {
                ...
                throw new Exception($"FAILED GetPacketDataRange: {ex}");
            }
        }
